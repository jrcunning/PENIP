...
dir.create("outputs/combined_assets", recursive = TRUE, showWarnings = FALSE)
saveRDS(p_final_with_inset, "outputs/combined_assets/coral_fig1_panel_a_ggplot.rds")
saveRDS(iz_plot_clean, "outputs/combined_assets/coral_fig1_panel_c_ggplot.rds")
ggsave(
  "outputs/combined_assets/coral_fig1_panel_c.png",
  iz_plot_clean,
  width = 85,
  height = 120,
  units = "mm",
...
write_csv(tot3_intervals, file = "outputs/Table2_coral_intervals.csv")
```
