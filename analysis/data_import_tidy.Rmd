...
area <- mod_nb3$data$transect_area_m2

y <- mod_nb3$data$n / area
set.seed(123)
yrep  <- posterior_predict(mod_nb3, ndraws = 300)
yrep <- sweep(yrep, 2, area, FUN = "/")
set.seed(123)
mu    <- posterior_epred(mod_nb3, ndraws = 300)  # matrix: draws x observations
...
fig2
ggsave(filename = "outputs/Fig2neww.png", width = 170, height = 170, units = "mm", dpi = 300)
