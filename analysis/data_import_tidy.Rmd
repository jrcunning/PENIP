...
# Create new polygon covering full monitoring area, from 1.2 km N to 1.2 km S of the channel
...
new_zone <- st_sf(
  folder = "Generated",
  name = "Full Monitoring Area",
  scenario = "Full Monitoring Area",
...
zone_levels <- c("Channel", "Side Slopes", "Depth_10cm", "Depth_5cm", "Depth_1cm", "Depth_0_5cm", "Depth_0_1cm",
                 "Nearshore", "North", "East", "South", "Full Monitoring Area")
...
# Combine for full Scenario2+NMFS, and full monitoring area
