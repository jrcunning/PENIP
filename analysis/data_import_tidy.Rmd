...
vmr_summary <- dfftaxon %>%
  group_by(taxon, class, Type) %>%
  summarize(mean_n = mean(n), var_n = var(n), .groups = "drop") %>%
...
ppreds <- add_predicted_draws(mod_nb3, newdata = dfftaxon_trimmed2, ndraws = 1000)
...
pp_check(mod_nb3, type = "stat_grouped", group = "taxon", stat = "mean", ndraws = 600)
pp_check(mod_nb3, type = "stat_grouped", group = "taxon", stat = "sd", ndraws = 600)
prop_zero <- function(x) mean(x == 0)
pp_check(mod_nb3, type = "stat_grouped", group = "taxon", stat = "prop_zero", ndraws = 600)

library(moments)
# Posterior predictive simulations
yrep <- posterior_predict(mod_nb3, ndraws = 600)
