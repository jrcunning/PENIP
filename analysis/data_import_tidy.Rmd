...
```{r}
# Import data
nsu110 <- readxl::read_xlsx("data/2011_nsu_esa/Port Everglades_NSU 2011and DCA 2017_ESA surveys.xlsx",
...
# All sites surveyed in tier 1, 3,600 m2 timed swims.
# If a site had ≥ 5 of a taxon, a tier 2 survey of 600 m2 was performed.
nsu11_counts <- nsu11_counts %>%
  mutate(area_m2 = case_when(n >= 5 ~ 600,
                             n < 5 ~ 3600))
...
mod_nb <- MASS::glm.nb(n ~ grp, data = drm_NRCS)
