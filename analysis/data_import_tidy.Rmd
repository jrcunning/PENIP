...
write_csv(area_summary_acres, file = "outputs/TableA2.csv")
```
...
summary_drm24_combined %>% filter(class != "All")
...
write_csv(tot3_2024, file = "outputs/TableA4.csv")
```
