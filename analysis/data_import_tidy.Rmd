...
yrep <- posterior_predict(mod_nb3, ndraws = 1000)
...
p1 <- pp_check(mod_nb3, type = "stat", stat = "mean", ndraws = 1000)
p2 <- pp_check(mod_nb3, type = "stat", stat = "var", ndraws = 1000)
prop_zero <- function(x) mean(x == 0)
p3 <- pp_check(mod_nb3, type = "stat", stat = "prop_zero", ndraws = 1000)
p4 <- pp_check(mod_nb3, type = "stat", stat = "skewness", ndraws = 1000)
