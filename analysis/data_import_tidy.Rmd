...
## 1.4. 2021 Tetra Tech Recon Survey
```{r}

```


## 1.5. Habitat classification polygons
...
totals %>% filter(taxon == "ACER") %>%
  group_by(dataset) %>%
  summarize(tot_lower = sum(tot_lower),
            tot_upper = sum(tot_upper))
```
